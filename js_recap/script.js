const data = [
  ...
  function getBook(id) {
    return data.find((d) => d.id === id); //data is the name of array of objects defined above
  }
  ...
  const {  id, title, author, pages, publicationDate, genres, hasMovieAdaptation } = book;
